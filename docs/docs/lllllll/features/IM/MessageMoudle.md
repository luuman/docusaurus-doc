...
| dialogId             | string | "b29Lb8co7ew"                           | 对话ID      |
| f                    | string | "b29Lb8co7ew"                           |              |
| filelisttype         | string | 2                                       | 文件列表类型 |
| isStar               | string | null                                    |              |
| messageStatus        | string | null                                    |              |
| meta                 | string | Object                                  | 元数据       |
| download             | string | Object                                  | 下载信息     |
| filename             | string | "春夏秋冬的你-王宇良.mp3"               | 文件名       |
| hmacKey              | string | "6c76dacf6f8a30ba3aaa21514a4aff4a"      | HMAC密钥     |
| iKey                 | string | "93061dd1c04c4f87c2c6c1106cb6464dffef" | 加密密钥     |
| isOrigin             | string | 0                                       | 是否为源文件 |
| originSha256         | string | "9b108a72e82037f5a7576bda0e6c3635f"    | 原始文件的SHA256 |
| progress             | string | Object                                  | 进度信息     |
| enabled              | string | true                                    | 是否启用     |
| loaded               | string | 0                                       | 已加载字节数 |
| sendStatus           | string | ""                                      | 发送状态     |
| total                | string | 4741468                                 | 文件总大小   |
| type                 | string | "download"                              | 类型         |
| uploadOriginFilePath | string | ""                                      | 上传源文件路径 |
| s                    | string | "DXosN_0WjSo"                           |              |
| stime                | string | 1669124363203                           | 发送时间     |
